...
public final class SnackbarHelper {
  ...
  public void showMessage(Activity activity, String message, int length) {
    if (!message.isEmpty() && (!isShowing() || !lastMessage.equals(message))) {
      lastMessage = message;
      show(activity, message, DismissBehavior.HIDE, length);
    }
  }

  /** Shows a snackbar with a given message, and a dismiss button. */
  public void showMessageWithDismiss(Activity activity, String message, int length) {
    show(activity, message, DismissBehavior.SHOW, length);
  }
   ...
   */
  public void showError(Activity activity, String errorMessage, int length) {
    show(activity, errorMessage, DismissBehavior.FINISH, length);
  }
  ...
  private void show(
      final Activity activity, final String message, final DismissBehavior dismissBehavior, int length) {
    activity.runOnUiThread(
        new Runnable() {
          @Override
          public void run() {
